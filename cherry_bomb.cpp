// Author: Saikat_deb | Created: 2025-04-26 00:18
...
void solve()
{
    ...
    itr(i, n)
    {
        if (flag)
        {
            ...
            if ((b[i] == -1) and (((a[i] + k) < target) or (a[i] > target)))
            {
                cout << "0\n";
                return;
            }
    ...
    int value1 = abs(k + mn), value2 = abs(mx);
    dbg(value1, value2);
    cout << max(value1, value2) - min(value1, value2) + 1 << "\n";
}
