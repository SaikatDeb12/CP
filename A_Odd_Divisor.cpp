// Author: Saikat_deb | Created: 2025-05-11 12:48
...
void solve()
{
    ...
    {
        // no. has odd divisor iff its not in the form 2^n
        // no is in the form 2^n.. if it has only 1bit set
        int set = __builtin_popcountll(n);
        if (set == 1)
            cout << "NO\n";
        else
            cout << "YES\n";
